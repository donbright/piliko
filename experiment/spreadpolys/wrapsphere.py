...
# we use spread polynomials to generate the rational points. sort of.


# this example is not a sphere.. but its an interesting example of 
# what happens when the spread poly 'wraps around', so to speak?
#
...
def sphere_tessellation( cx, cy, cz, cr ):
	...
	points=[]
		...
		for n in range(0,depth2):
			s = spread_polynomial(n,Fraction(13*13,85*85))
